...
public class StoreDBClass {
    ...
    public void storedbclass(){
            store[0] = new StoreClass("대일전기", "전기","대전광역시 대덕구 오전동 370-9", 36.349524, 127.414039, "042-633-0765", "NULL", "NULL", 0,0);
            ...
            store[19] = new StoreClass("경보상사", "공구","대전광역시 대덕구 오절오 27",36.349964,127.413610,"NULL","NULL","NULL",0,0);
            ...
            store[54] = new StoreClass("동양전기조명","조명","대전광역시 대덕구 오정로 31",36.350364,127.413069,"042-639-8985","월~일 07:30~09:00","X",1,0);
            ...
            store[66] = new StoreClass("광명전기공조","모터펌프","대전광역시 대덕구 오정동 324-8",36.352763,127.409635,"011-409-3431","월~토 07:30~19:00 / 일 07:30~14:00","X",1,0);
    }
}